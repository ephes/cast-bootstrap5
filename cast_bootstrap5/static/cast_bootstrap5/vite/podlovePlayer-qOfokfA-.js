var H=Object.defineProperty;var $=(r,i,e)=>i in r?H(r,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[i]=e;var u=(r,i,e)=>$(r,typeof i!="symbol"?i+"":i,e);let p=null,A=0,b=null,g=null,I=null;const C="data-podlove-embed",k="data-podlove-embed-loaded",E="data-podlove-embed-failed",S="podlove-player-styles",_="color_scheme",y="#1e293b",v="#ffffff",D=300,M=320,x=100,z=700,F=2500,R="data-cast-iframe-masked",f="podlove-player-curtain",L=220,V=120,q=450;function N(){return document.readyState==="complete"?Promise.resolve():(b||(b=new Promise(r=>{window.addEventListener("load",()=>r(),{once:!0})})),b)}function B(){return g||(g=new IntersectionObserver((r,i)=>{r.forEach(e=>{if(!e.isIntersecting)return;const t=e.target;t instanceof w&&t.initializePlayer(),i.unobserve(t)})})),g}function G(r){return typeof podlovePlayer=="function"?Promise.resolve():p||(p=new Promise((i,e)=>{const t=document.querySelector(`script[${C}]`);if(t){if(t.getAttribute(k)==="true"&&typeof podlovePlayer=="function"){i();return}if(t.getAttribute(E)==="true")t.remove();else{t.addEventListener("load",()=>i(),{once:!0}),t.addEventListener("error",()=>{t.setAttribute(E,"true"),t.remove(),p=null,e(new Error("Failed to load Podlove embed script"))},{once:!0});return}}const n=document.createElement("script");n.src=r,n.async=!0,n.setAttribute(C,"true"),n.addEventListener("load",()=>{n.setAttribute(k,"true"),i()},{once:!0}),n.addEventListener("error",()=>{n.setAttribute(E,"true"),n.remove(),p=null,e(new Error("Failed to load Podlove embed script"))},{once:!0}),document.head.appendChild(n)}),p)}function U(r){const i=r.match(/rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/i);if(!i)return null;const[,e,t,n]=i;return[Number(e),Number(t),Number(n)]}function P(r){return r==="transparent"||r==="rgba(0, 0, 0, 0)"}function O(r){const i=U(r);if(!i)return null;const[e,t,n]=i;return(.2126*e+.7152*t+.0722*n)/255<.5}function K(){const r=[document.body,document.documentElement];for(const i of r){if(!i)continue;const e=window.getComputedStyle(i).backgroundColor;if(!e||P(e))continue;const t=O(e);if(t!==null)return t}return null}function T(){var e,t;const r=document.documentElement.getAttribute("data-bs-theme")||document.documentElement.getAttribute("data-theme")||((e=document.body)==null?void 0:e.getAttribute("data-bs-theme"))||((t=document.body)==null?void 0:t.getAttribute("data-theme"));if(r==="light"||r==="dark")return r;if(typeof window.matchMedia=="function"&&window.matchMedia("(prefers-color-scheme: dark)").matches)return"dark";const i=K();return i!==null?i?"dark":"light":null}function Y(r){const i=[r,r.parentElement,document.body,document.documentElement];for(const e of i){if(!e)continue;const t=window.getComputedStyle(e).backgroundColor;if(t&&!P(t))return t}return v}function W(r){const i=T();if(!i)return r;const e=r.indexOf("#"),t=e===-1?r:r.slice(0,e),n=e===-1?"":r.slice(e+1),a=t.indexOf("?"),l=a===-1?t:t.slice(0,a),c=a===-1?"":t.slice(a+1),m=new URLSearchParams(c);m.has(_)||m.set(_,i);const s=m.toString(),h=n?`#${n}`:"";return s?`${l}?${s}${h}`:`${l}${h}`}function X(){return typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches?M:D}class w extends HTMLElement{constructor(){super();u(this,"observer");u(this,"isInitialized");u(this,"playerDiv");u(this,"initVersion");u(this,"iframeObserver");u(this,"iframeRevealTimeoutId");u(this,"iframeCurtainTimeoutId");this.observer=null,this.isInitialized=!1,this.playerDiv=null,this.initVersion=0,this.iframeObserver=null,this.iframeRevealTimeoutId=null,this.iframeCurtainTimeoutId=null}reinitializePlayer(){!this.isInitialized||!this.isConnected||(this.clearIframeMasking(),this.playerDiv&&(this.playerDiv.remove(),this.playerDiv=null),this.isInitialized=!1,delete this.dataset.playerInstanceId,this.initializePlayer())}connectedCallback(){if(this.renderPlaceholder(),document.readyState==="complete"){this.observeElement();return}N().then(()=>this.observeElement())}disconnectedCallback(){this.observer&&this.observer.unobserve(this),this.clearIframeMasking(),this.initVersion+=1,this.isInitialized=!1}clearIframeMasking(){this.iframeObserver&&(this.iframeObserver.disconnect(),this.iframeObserver=null),this.iframeRevealTimeoutId!==null&&(window.clearTimeout(this.iframeRevealTimeoutId),this.iframeRevealTimeoutId=null),this.iframeCurtainTimeoutId!==null&&(window.clearTimeout(this.iframeCurtainTimeoutId),this.iframeCurtainTimeoutId=null),this.querySelectorAll(`.${f}`).forEach(e=>e.remove())}applyReservedHeight(e){const t=`${X()}px`;e.style.minHeight=t,this.style.minHeight=t}maskIframeUntilReady(e,t){if(!(e instanceof HTMLElement))return;this.clearIframeMasking();const n=e.style.colorScheme==="dark"?z:x,a=e.style.colorScheme==="dark"?q:V,l=()=>{const o=e.querySelector(`.${f}`);if(o instanceof HTMLDivElement)return o.style.backgroundColor=e.style.backgroundColor||window.getComputedStyle(e).backgroundColor,o.style.opacity="1",o;const d=document.createElement("div");return d.classList.add(f),d.style.backgroundColor=e.style.backgroundColor||window.getComputedStyle(e).backgroundColor,e.appendChild(d),d},c=o=>{if(this.initVersion!==t)return;o.style.opacity="1",o.style.pointerEvents="",o.style.removeProperty("transition");const d=l();this.iframeCurtainTimeoutId=window.setTimeout(()=>{this.initVersion===t&&(d.style.opacity="0",this.iframeCurtainTimeoutId=window.setTimeout(()=>{this.initVersion===t&&(d.remove(),this.releaseReservedHeight(e),this.iframeCurtainTimeoutId=null)},L))},a),this.iframeRevealTimeoutId!==null&&(window.clearTimeout(this.iframeRevealTimeoutId),this.iframeRevealTimeoutId=null)},m=o=>{window.setTimeout(()=>c(o),n)},s=o=>{o.getAttribute(R)!=="true"&&(l(),o.setAttribute(R,"true"),o.style.opacity="0",o.style.pointerEvents="none",o.style.transition="opacity 160ms ease",o.style.backgroundColor="inherit",o.style.colorScheme="inherit",o.addEventListener("load",()=>m(o),{once:!0}),this.iframeRevealTimeoutId=window.setTimeout(()=>c(o),F))},h=e.querySelector("iframe");if(h instanceof HTMLIFrameElement){s(h);return}this.iframeObserver=new MutationObserver(()=>{const o=e.querySelector("iframe");o instanceof HTMLIFrameElement&&(s(o),this.iframeObserver&&(this.iframeObserver.disconnect(),this.iframeObserver=null))}),this.iframeObserver.observe(e,{childList:!0,subtree:!0})}applyLoadingTheme(e){if(!(e instanceof HTMLElement))return;const t=Y(this),n=O(t);e.style.backgroundColor=t,e.style.colorScheme=n===!0?"dark":"light"}renderPlaceholder(){if(this.querySelector(".podlove-player-container"))return;if(!document.getElementById(S)){const t=document.createElement("style");t.id=S,t.textContent=`
        ...
        podlove-player .podlove-player-container .${f} {
          position: absolute;
          inset: 0;
          pointer-events: none;
          z-index: 2;
