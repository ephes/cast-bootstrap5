var q=Object.defineProperty;var F=(l,i,e)=>i in l?q(l,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[i]=e;var d=(l,i,e)=>F(l,typeof i!="symbol"?i+"":i,e);let m=null,D=0,T=null,A=null,_=null;const k="data-podlove-embed",M="data-podlove-embed-loaded",S="data-podlove-embed-failed",P="podlove-player-styles",C="color_scheme",b="#1e293b",E="#ffffff",$=297,x=309,z=100,N=900,K=2500,v="data-cast-iframe-masked",y="data-cast-mask-active",I="podlove-player-reveal-shield",B=80,U=180,H=120,V="#paging-area",Y=".pagination a, .cast-pagination a",p="data-cast-paging-remask",W=1600,X="data-cast-paging-mask-active",j=50;function J(){return document.readyState==="complete"?Promise.resolve():(T||(T=new Promise(l=>{window.addEventListener("load",()=>l(),{once:!0})})),T)}function Q(){return A||(A=new IntersectionObserver((l,i)=>{l.forEach(e=>{if(!e.isIntersecting)return;const t=e.target;t instanceof w&&t.initializePlayer(),i.unobserve(t)})})),A}function Z(l){return typeof podlovePlayer=="function"?Promise.resolve():m||(m=new Promise((i,e)=>{const t=document.querySelector(`script[${k}]`);if(t){if(t.getAttribute(M)==="true"&&typeof podlovePlayer=="function"){i();return}if(t.getAttribute(S)==="true")t.remove();else{t.addEventListener("load",()=>i(),{once:!0}),t.addEventListener("error",()=>{t.setAttribute(S,"true"),t.remove(),m=null,e(new Error("Failed to load Podlove embed script"))},{once:!0});return}}const r=document.createElement("script");r.src=l,r.async=!0,r.setAttribute(k,"true"),r.addEventListener("load",()=>{r.setAttribute(M,"true"),i()},{once:!0}),r.addEventListener("error",()=>{r.setAttribute(S,"true"),r.remove(),m=null,e(new Error("Failed to load Podlove embed script"))},{once:!0}),document.head.appendChild(r)}),m)}function g(){var i,e;const l=document.documentElement.getAttribute("data-bs-theme")||document.documentElement.getAttribute("data-theme")||((i=document.body)==null?void 0:i.getAttribute("data-bs-theme"))||((e=document.body)==null?void 0:e.getAttribute("data-theme"));return l==="light"||l==="dark"?l:typeof window.matchMedia=="function"&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":null}function ee(l){const i=g();if(!i)return l;const e=l.indexOf("#"),t=e===-1?l:l.slice(0,e),r=e===-1?"":l.slice(e+1),a=t.indexOf("?"),n=a===-1?t:t.slice(0,a),c=a===-1?"":t.slice(a+1),u=new URLSearchParams(c);u.has(C)||u.set(C,i);const s=u.toString(),h=r?`#${r}`:"";return s?`${n}?${s}${h}`:`${n}${h}`}function te(){return typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches?x:$}function ie(l,i){i.getAttribute(p)!=="true"&&(i.setAttribute(p,"true"),i.setAttribute(v,"true"),i.style.opacity="0",i.style.pointerEvents="none",i.style.backgroundColor="inherit",i.style.colorScheme="inherit",l.setAttribute(y,"true"),window.setTimeout(()=>{!i.isConnected||i.getAttribute(p)!=="true"||(i.removeAttribute(p),i.getAttribute(v)==="true"&&i.removeAttribute(v),i.style.removeProperty("opacity"),i.style.removeProperty("pointer-events"),i.style.removeProperty("background-color"),i.style.removeProperty("color-scheme"),l.querySelector(`iframe[${p}="true"]`)||l.removeAttribute(y))},W))}function re(l){const i=l.target;if(!(i instanceof Element)||!i.closest(Y))return;const e=document.querySelector(V);e&&e.querySelectorAll(".podlove-player-container").forEach(t=>{t instanceof HTMLElement&&t.querySelectorAll("iframe").forEach(r=>{r instanceof HTMLIFrameElement&&r.getAttribute(v)!=="true"&&ie(t,r)})})}class w extends HTMLElement{constructor(){super();d(this,"observer");d(this,"isInitialized");d(this,"playerDiv");d(this,"initVersion");d(this,"iframeObserver");d(this,"iframeRevealDelayTimeoutId");d(this,"iframeRevealTimeoutId");d(this,"iframeRevealShieldTimeoutId");this.observer=null,this.isInitialized=!1,this.playerDiv=null,this.initVersion=0,this.iframeObserver=null,this.iframeRevealDelayTimeoutId=null,this.iframeRevealTimeoutId=null,this.iframeRevealShieldTimeoutId=null}reinitializePlayer(){!this.isInitialized||!this.isConnected||(this.clearIframeMasking(),this.playerDiv&&(this.playerDiv.remove(),this.playerDiv=null),this.isInitialized=!1,delete this.dataset.playerInstanceId,this.initializePlayer())}connectedCallback(){if(this.renderPlaceholder(),document.readyState==="complete"){this.observeElement();return}J().then(()=>this.observeElement())}disconnectedCallback(){this.observer&&this.observer.unobserve(this),this.clearIframeMasking(),this.initVersion+=1,this.isInitialized=!1}clearIframeMasking(){this.iframeObserver&&(this.iframeObserver.disconnect(),this.iframeObserver=null),this.iframeRevealDelayTimeoutId!==null&&(window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=null),this.iframeRevealTimeoutId!==null&&(window.clearTimeout(this.iframeRevealTimeoutId),this.iframeRevealTimeoutId=null),this.iframeRevealShieldTimeoutId!==null&&(window.clearTimeout(this.iframeRevealShieldTimeoutId),this.iframeRevealShieldTimeoutId=null),this.querySelectorAll(".podlove-player-container").forEach(e=>{e instanceof HTMLElement&&(e.removeAttribute(y),e.querySelectorAll(`.${I}`).forEach(t=>{t.remove()}))})}applyReservedHeight(e){const t=`${te()}px`;e.style.minHeight=t,this.style.minHeight=t}getOrCreateRevealShield(e){const t=e.querySelector(`.${I}`);if(t instanceof HTMLDivElement)return t.style.backgroundColor=e.style.backgroundColor||window.getComputedStyle(e).backgroundColor,t.style.opacity="1",t;const r=document.createElement("div");return r.classList.add(I),r.style.backgroundColor=e.style.backgroundColor||window.getComputedStyle(e).backgroundColor,r.style.opacity="1",e.appendChild(r),r}scheduleRevealShieldRelease(e,t){this.iframeRevealShieldTimeoutId!==null&&(window.clearTimeout(this.iframeRevealShieldTimeoutId),this.iframeRevealShieldTimeoutId=null);const r=this.getOrCreateRevealShield(e),a=e.style.colorScheme==="dark"?U:B;this.iframeRevealShieldTimeoutId=window.setTimeout(()=>{this.initVersion===t&&(r.style.opacity="0",this.iframeRevealShieldTimeoutId=window.setTimeout(()=>{this.initVersion===t&&(r.remove(),this.releaseReservedHeight(e),this.iframeRevealShieldTimeoutId=null)},H))},a)}maskIframeUntilReady(e,t){if(!(e instanceof HTMLElement))return;this.clearIframeMasking(),e.setAttribute(y,"true");const r=e.style.colorScheme==="dark"?N:z,a=new WeakSet;let n=null;const c=()=>{const o=document.querySelector(V);return(o==null?void 0:o.getAttribute(X))==="true"},u=o=>o.getAttribute(p)==="true"?!0:c(),s=o=>{if(this.initVersion===t&&!(!(o instanceof HTMLIFrameElement)||!e.contains(o))){if(u(o)){this.iframeRevealDelayTimeoutId!==null&&window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=window.setTimeout(()=>s(o),j);return}o.style.opacity="1",o.style.pointerEvents="",o.style.removeProperty("transition"),o.style.removeProperty("background-color"),o.style.removeProperty("color-scheme"),o.removeAttribute(v),e.removeAttribute(y),this.scheduleRevealShieldRelease(e,t),this.iframeRevealTimeoutId!==null&&(window.clearTimeout(this.iframeRevealTimeoutId),this.iframeRevealTimeoutId=null),this.iframeRevealDelayTimeoutId!==null&&(window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=null)}},h=o=>{this.iframeRevealDelayTimeoutId!==null&&window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=window.setTimeout(()=>s(o),r)},R=o=>{a.has(o)||(a.add(o),n=o,this.getOrCreateRevealShield(e),o.setAttribute(v,"true"),o.style.opacity="0",o.style.pointerEvents="none",o.style.transition="opacity 160ms ease",o.style.backgroundColor="inherit",o.style.colorScheme="inherit",o.addEventListener("load",()=>{n===o&&h(o)},{once:!0}),this.iframeRevealTimeoutId!==null&&window.clearTimeout(this.iframeRevealTimeoutId),this.iframeRevealTimeoutId=window.setTimeout(()=>s(n),K))},f=()=>{e.querySelectorAll("iframe").forEach(L=>{L instanceof HTMLIFrameElement&&R(L)})};f(),this.iframeObserver=new MutationObserver(()=>{f()}),this.iframeObserver.observe(e,{childList:!0,subtree:!0})}applyLoadingTheme(e){if(!(e instanceof HTMLElement))return;const t=g()==="dark"?"dark":"light";e.style.backgroundColor=t==="dark"?b:E,e.style.colorScheme=t}renderPlaceholder(){if(this.querySelector(".podlove-player-container"))return;if(!document.getElementById(P)){const t=document.createElement("style");t.id=P,t.textContent=`
