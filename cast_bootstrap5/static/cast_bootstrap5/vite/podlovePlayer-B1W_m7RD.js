var K=Object.defineProperty;var Y=(a,r,e)=>r in a?K(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var d=(a,r,e)=>Y(a,typeof r!="symbol"?r+"":r,e);let v=null,D=0,R=null,L=null,M=null;const H="data-podlove-embed",x="data-podlove-embed-loaded",_="data-podlove-embed-failed",O="podlove-player-styles",q="color_scheme",U="#292524",W="#ffffff",z=297,V=312,X=100,j=900,J=2500,Q=8e3,b="data-cast-iframe-masked",f="data-cast-mask-active",I="podlove-player-reveal-shield",Z=80,ee=180,F=120,G="#paging-area",te=".pagination a, .cast-pagination a",y="data-cast-paging-remask",oe=1600,re="data-cast-paging-mask-active",ie=50;function ae(){return document.readyState==="complete"?Promise.resolve():(R||(R=new Promise(a=>{window.addEventListener("load",()=>a(),{once:!0})})),R)}function w(a){const r=a?"--cast-bg-alt":"--cast-surface",e=a?U:W;return getComputedStyle(document.documentElement).getPropertyValue(r).trim()||e}const S="podlove-player-facade-btn",E="podlove-player-facade-loading";function le(){return L||(L=new IntersectionObserver((a,r)=>{a.forEach(e=>{if(!e.isIntersecting)return;const t=e.target;r.unobserve(t),t instanceof k&&t.showFacade()})})),L}function ne(a){return typeof podlovePlayer=="function"?Promise.resolve():v||(v=new Promise((r,e)=>{const t=document.querySelector(`script[${H}]`);if(t){if(t.getAttribute(x)==="true"&&typeof podlovePlayer=="function"){r();return}if(t.getAttribute(_)==="true")t.remove();else{t.addEventListener("load",()=>r(),{once:!0}),t.addEventListener("error",()=>{t.setAttribute(_,"true"),t.remove(),v=null,e(new Error("Failed to load Podlove embed script"))},{once:!0});return}}const o=document.createElement("script");o.src=a,o.async=!0,o.setAttribute(H,"true"),o.addEventListener("load",()=>{o.setAttribute(x,"true"),r()},{once:!0}),o.addEventListener("error",()=>{o.setAttribute(_,"true"),o.remove(),v=null,e(new Error("Failed to load Podlove embed script"))},{once:!0}),document.head.appendChild(o)}),v)}function A(){var r,e;const a=document.documentElement.getAttribute("data-bs-theme")||document.documentElement.getAttribute("data-theme")||((r=document.body)==null?void 0:r.getAttribute("data-bs-theme"))||((e=document.body)==null?void 0:e.getAttribute("data-theme"));return a==="light"||a==="dark"?a:typeof window.matchMedia=="function"&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":null}function se(a){const r=A();if(!r)return a;const e=a.indexOf("#"),t=e===-1?a:a.slice(0,e),o=e===-1?"":a.slice(e+1),l=t.indexOf("?"),n=l===-1?t:t.slice(0,l),c=l===-1?"":t.slice(l+1),h=new URLSearchParams(c);h.has(q)||h.set(q,r);const s=h.toString(),m=o?`#${o}`:"";return s?`${n}?${s}${m}`:`${n}${m}`}function de(){return typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches?V:z}function ce(a,r){r.getAttribute(y)!=="true"&&(r.setAttribute(y,"true"),r.setAttribute(b,"true"),r.style.opacity="0",r.style.pointerEvents="none",r.style.backgroundColor="inherit",r.style.colorScheme="inherit",a.setAttribute(f,"true"),window.setTimeout(()=>{!r.isConnected||r.getAttribute(y)!=="true"||(r.removeAttribute(y),r.getAttribute(b)==="true"&&r.removeAttribute(b),r.style.opacity="1",r.style.pointerEvents="",r.style.removeProperty("background-color"),r.style.removeProperty("color-scheme"),a.querySelector(`iframe[${y}="true"]`)||a.removeAttribute(f))},oe))}function ue(a){const r=a.target;if(!(r instanceof Element)||!r.closest(te))return;const e=document.querySelector(G);e&&e.querySelectorAll(".podlove-player-container").forEach(t=>{t instanceof HTMLElement&&t.querySelectorAll("iframe").forEach(o=>{o instanceof HTMLIFrameElement&&o.getAttribute(b)!=="true"&&ce(t,o)})})}class k extends HTMLElement{constructor(){super();d(this,"observer");d(this,"isInitialized");d(this,"playerDiv");d(this,"initVersion");d(this,"iframeObserver");d(this,"iframeRevealDelayTimeoutId");d(this,"iframeRevealTimeoutId");d(this,"iframeRevealShieldTimeoutId");d(this,"facadeAbortController");this.observer=null,this.isInitialized=!1,this.playerDiv=null,this.initVersion=0,this.iframeObserver=null,this.iframeRevealDelayTimeoutId=null,this.iframeRevealTimeoutId=null,this.iframeRevealShieldTimeoutId=null,this.facadeAbortController=null}isFacadeMode(){return this.getAttribute("data-load-mode")==="facade"}reinitializePlayer(){!this.isInitialized||!this.isConnected||(this.clearIframeMasking(),this.playerDiv&&(this.playerDiv.remove(),this.playerDiv=null),this.isInitialized=!1,delete this.dataset.playerInstanceId,this.initializePlayer())}connectedCallback(){if(this.renderPlaceholder(),this.isFacadeMode()){this.setupFacadeInteraction();return}if(document.readyState==="complete"){this.observeElement();return}ae().then(()=>this.observeElement())}disconnectedCallback(){var o,l;this.observer&&this.observer.unobserve(this),this.facadeAbortController&&(this.facadeAbortController.abort(),this.facadeAbortController=null),this.clearIframeMasking(),(o=this.querySelector(`.${E}`))==null||o.remove(),(l=this.querySelector(`.${S}`))==null||l.remove();const e=this.querySelector(".podlove-facade-inner");e instanceof HTMLElement&&(e.style.removeProperty("position"),e.style.removeProperty("inset"),e.style.removeProperty("z-index"),e.style.removeProperty("padding"));const t=this.querySelector(".podlove-player-container");t instanceof HTMLElement&&(this.isFacadeMode()&&t.classList.add("podlove-facade"),t.classList.remove("is-loading"),t.style.removeProperty("min-height")),this.style.removeProperty("min-height"),this.initVersion+=1,this.isInitialized=!1}clearIframeMasking(){this.iframeObserver&&(this.iframeObserver.disconnect(),this.iframeObserver=null),this.iframeRevealDelayTimeoutId!==null&&(window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=null),this.iframeRevealTimeoutId!==null&&(window.clearTimeout(this.iframeRevealTimeoutId),this.iframeRevealTimeoutId=null),this.iframeRevealShieldTimeoutId!==null&&(window.clearTimeout(this.iframeRevealShieldTimeoutId),this.iframeRevealShieldTimeoutId=null),this.querySelectorAll(".podlove-player-container").forEach(e=>{e instanceof HTMLElement&&(e.removeAttribute(f),e.querySelectorAll(`.${I}`).forEach(t=>{t.remove()}))})}applyReservedHeight(e){const t=`${de()}px`;e.style.minHeight=t,this.style.minHeight=t}getOrCreateRevealShield(e){const t=e.querySelector(`.${I}`);if(t instanceof HTMLDivElement)return t.style.backgroundColor=e.style.backgroundColor||window.getComputedStyle(e).backgroundColor,t.style.opacity="1",t;const o=document.createElement("div");return o.classList.add(I),o.style.backgroundColor=e.style.backgroundColor||window.getComputedStyle(e).backgroundColor,o.style.opacity="1",e.appendChild(o),o}scheduleRevealShieldRelease(e,t){this.iframeRevealShieldTimeoutId!==null&&(window.clearTimeout(this.iframeRevealShieldTimeoutId),this.iframeRevealShieldTimeoutId=null);const o=this.getOrCreateRevealShield(e),l=e.style.colorScheme==="dark"?ee:Z;this.iframeRevealShieldTimeoutId=window.setTimeout(()=>{this.initVersion===t&&(o.style.opacity="0",this.iframeRevealShieldTimeoutId=window.setTimeout(()=>{this.initVersion===t&&(o.remove(),this.releaseReservedHeight(e),this.iframeRevealShieldTimeoutId=null)},F))},l)}maskIframeUntilReady(e,t){if(!(e instanceof HTMLElement))return;this.clearIframeMasking(),e.setAttribute(f,"true");const o=e.style.colorScheme==="dark"?j:X,l=new WeakSet;let n=null;const c=()=>{const i=document.querySelector(G);return(i==null?void 0:i.getAttribute(re))==="true"},h=i=>i.getAttribute(y)==="true"?!0:c(),s=i=>{var u,p;if(this.initVersion===t&&!(!(i instanceof HTMLIFrameElement)||!e.contains(i))){if(h(i)){this.iframeRevealDelayTimeoutId!==null&&window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=window.setTimeout(()=>s(i),ie);return}(u=e.querySelector(".podlove-facade-inner"))==null||u.remove(),(p=this.querySelector(".podlove-facade-inner"))==null||p.remove(),i.style.opacity="1",i.style.pointerEvents="",i.style.removeProperty("transition"),i.style.removeProperty("background-color"),i.style.removeProperty("color-scheme"),i.removeAttribute(b),e.removeAttribute(f),this.scheduleRevealShieldRelease(e,t),this.iframeRevealTimeoutId!==null&&(window.clearTimeout(this.iframeRevealTimeoutId),this.iframeRevealTimeoutId=null),this.iframeRevealDelayTimeoutId!==null&&(window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=null)}},m=i=>{this.iframeRevealDelayTimeoutId!==null&&window.clearTimeout(this.iframeRevealDelayTimeoutId),this.iframeRevealDelayTimeoutId=window.setTimeout(()=>s(i),o)},T=i=>{var C,P;if(l.has(i))return;l.add(i),n=i,this.getOrCreateRevealShield(e);const u=e.querySelector(`.${E}`);u&&u.remove();const p=e.querySelector(".podlove-facade-inner");p instanceof HTMLElement&&(p.style.position="absolute",p.style.inset="0",p.style.zIndex="1",p.style.padding="inherit"),(C=e.querySelector(".podlove-facade-content"))==null||C.remove(),(P=e.querySelector(".podlove-facade-play:not(.podlove-facade-inner .podlove-facade-play)"))==null||P.remove(),e.classList.remove("podlove-facade"),i.setAttribute(b,"true"),i.style.opacity="0",i.style.pointerEvents="none",i.style.transition="opacity 160ms ease",i.style.backgroundColor="inherit",i.style.colorScheme="inherit",i.addEventListener("load",()=>{n===i&&m(i)},{once:!0}),this.iframeRevealTimeoutId!==null&&window.clearTimeout(this.iframeRevealTimeoutId);const B=e.style.colorScheme==="dark"?Q:J;this.iframeRevealTimeoutId=window.setTimeout(()=>s(n),B)},g=()=>{e.querySelectorAll("iframe").forEach(u=>{u instanceof HTMLIFrameElement&&T(u)})};g(),this.iframeObserver=new MutationObserver(()=>{g()}),this.iframeObserver.observe(e,{childList:!0,subtree:!0})}applyLoadingTheme(e){if(!(e instanceof HTMLElement))return;const t=A()==="dark"?"dark":"light";e.style.backgroundColor=w(t==="dark"),e.style.colorScheme=t}ensurePlayerStyles(){if(document.getElementById(O))return;const e=document.createElement("style");e.id=O;const t=w(!0),o=w(!1);e.textContent=`
